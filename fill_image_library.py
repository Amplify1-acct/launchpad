...
PROMPTS = {
    ...
    "gym": [
        "Photorealistic personal trainer in athletic wear smiling at camera, bright gym background, professional portrait, no text no letters",
        "Photorealistic modern gym interior with free weights and cardio equipment, bright lighting, no people, no text no letters",
        "Photorealistic person doing a workout with a trainer, motivating action shot, bright gym, no text no letters",
        "Photorealistic close-up of hands gripping barbell during a lift, intensity and focus, no text no letters",
        "Photorealistic group fitness class in a bright modern studio, energetic atmosphere, no text no letters",
        "Photorealistic gym exterior with large windows showing equipment inside, daytime, no text no signs no letters",
    ],
    "pet": [
        "Photorealistic friendly veterinarian in white coat smiling at camera, clean clinic background, no text no letters",
        "Photorealistic dog groomer gently grooming a happy golden retriever on a table, professional setting, no text no letters",
        "Photorealistic veterinarian carefully examining a cat on an exam table, clean clinic, no text no letters",
        "Photorealistic happy dog being held by a smiling vet tech, bright clinic, no text no letters",
        "Photorealistic clean modern veterinary waiting room, comfortable seating, pets welcome, no text no letters",
        "Photorealistic pet care facility exterior, welcoming sign area, suburban setting, no text no signs no letters",
    ],
    "remodeling": [
        "Photorealistic contractor in work clothes smiling at camera, renovation site background, professional portrait, no text no letters",
        "Photorealistic beautifully remodeled modern kitchen with white cabinets and stone countertops, bright natural light, no text no letters",
        "Photorealistic luxurious remodeled bathroom with walk-in shower and modern fixtures, bright clean, no text no letters",
        "Photorealistic contractor installing kitchen cabinets, professional work, no text no letters",
        "Photorealistic stunning finished basement renovation, modern living space, bright lighting, no text no letters",
        "Photorealistic remodeling company truck and crew outside a suburban home, professional appearance, no text no letters",
    ],
    "moving": [
