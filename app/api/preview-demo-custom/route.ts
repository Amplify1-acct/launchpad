...
export async function GET(request: Request) {
  ...
  <div style="display:flex;align-items:center;gap:8px;flex:1;min-width:0;">
    ...
    <span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:12px;">Custom demo: <strong>${build.biz_name}</strong> in ${build.city}, ${build.state}</span>
    <span style="background:rgba(255,255,255,0.18);border-radius:4px;padding:2px 6px;font-size:10px;flex-shrink:0;white-space:nowrap;">${styleLabel}</span>
  </div>
