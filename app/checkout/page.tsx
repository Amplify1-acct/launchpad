...
const PLANS = [
  {
    ...
    price: "$99",
    period: "/mo",
    description: "Everything a small business needs to get found online and stay top of mind.",
    features: [
  ...
  },
  {
    ...
    price: "$299",
    period: "/mo",
    description: "Grow your presence with automated social media and more content.",
    features: [
      "AI-generated website",
      "5 AI images",
      "2 blog posts per week",
      "Social media queue (FB, IG, TT)",
      "Custom domain included",
      "Advanced SEO",
    ],
    highlight: true,
  },
  {
    ...
    price: "$599",
    period: "/mo",
    description: "Full autopilot — website, content, social, and real Google reviews on your site.",
    features: [
      "AI-generated website",
      "5 AI images",
