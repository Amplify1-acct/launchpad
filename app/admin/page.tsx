...
const S = {
    ...
    filterBtn: (active) => ({ padding: "8px 16px", borderRadius: 100, border: "1px solid", borderColor: active ? "#4648d4" : "#dde2ff", background: active ? "#4648d4" : "#fff", color: active ? "#fff" : "#4648d4", fontSize: 13, fontWeight: 600, cursor: "pointer" }),
    ...
    btn: (color) => ({ padding: "10px 18px", borderRadius: 8, border: "none", background: color, color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer" }),
